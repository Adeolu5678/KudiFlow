...
export const seedLedgerEntries: LedgerEntry[] = [
  {
    ...
    paymentStatus: 'paid',
    counterparty: 'Tunde',
    items: [{ id: 'item-rice', name: 'Rice', quantity: null, unitPrice: null }],
    sourceType: 'text',
  ...
  },
  {
    ...
    items: [{ id: 'item-tomatoes', name: 'Tomatoes', quantity: null, unitPrice: null }],
    sourceType: 'manual',
  ...
  },
  {
    ...
    items: [{ id: 'item-garri', name: 'Garri', quantity: null, unitPrice: null }],
    sourceType: 'text',
  ...
  {
    id: 'seed-income-transfer',
    type: 'income',
    title: 'Transfer alert sale',
    amount: 25000,
    currency: 'NGN',
    date: '2026-05-02T12:10:00Z',
    paymentStatus: 'paid',
    counterparty: 'Customer',
    items: [],
    sourceType: 'bankAlertScreenshot',
    originalNote: 'Bank alert screenshot: CR 25,000',
    confidence: 0.84,
